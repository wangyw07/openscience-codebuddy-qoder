...
> This skill depends on Nano Banana Pro AI for image generation — an external
> third-party service that may be unavailable or require separate credentials.
> If Nano Banana Pro is unavailable, consider using matplotlib, plotly, or
> standard image generation APIs as a fallback.
